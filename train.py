...
if __name__ == "__main__":
    ...
    parser.add_argument('--da_method', default='SRR', type=str, help='Methods Settings.')

    # ========= Select the DATASET ==============
    parser.add_argument('--data_path', default=r'D:\Dataset', type=str, help='Path containing dataset')
    parser.add_argument('--dataset', default='HAR', type=str, help='Dataset Settings, such as HHAR.')
